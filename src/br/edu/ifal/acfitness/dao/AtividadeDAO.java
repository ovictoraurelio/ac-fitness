...
import br.edu.ifal.acfitness.vo.Atividade;
 ...
 * @author victor
 */
public class AtividadeDAO implements IDao<Atividade, Long>{
    
    
    private Connection conexaoBD;
    private static final String TABLE_NAME = "atividade";
    private static final Columns TABLE_COLUMNS = new Columns("nome", "cpf", "data", "sexo");
        
    @Override
    public ArrayList<Atividade> consultar(Atividade entity) throws SQLException {
    ...
    @Override
    public String alterar(Atividade entity) throws SQLException {
        this.conexaoBD = Conexao.getConexao();
    ...
    @Override
    public String inserir(Atividade entity) throws SQLException {                
        this.conexaoBD = Conexao.getConexao();
    ...
    @Override
    public String remover(Atividade entity) throws SQLException {
        this.conexaoBD = Conexao.getConexao();
